...
enum {
	...
	NET_EVENT_ETHERNET_CMD_FDB_ADD_VAL,
	NET_EVENT_ETHERNET_CMD_FDB_DEL_VAL,
...
enum net_event_ethernet_cmd {
	...
	NET_MGMT_CMD(NET_EVENT_ETHERNET_CMD_FDB_ADD),
	NET_MGMT_CMD(NET_EVENT_ETHERNET_CMD_FDB_DEL),
};
...
#define NET_EVENT_ETHERNET_FDB_ADD				\
	(NET_ETHERNET_EVENT | NET_EVENT_ETHERNET_CMD_FDB_ADD)

#define NET_EVENT_ETHERNET_FDB_DEL				\
	(NET_ETHERNET_EVENT | NET_EVENT_ETHERNET_CMD_FDB_DEL)
