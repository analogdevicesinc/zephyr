...
To sign the firmware image, user needs to enable ``CONFIG_MAX32_SECURE_SOC_SIGNING`` Kconfig option
and specify the path to the private key using ``CONFIG_MAX32_SECURE_SOC_KEY_PATH`` Kconfig option.
