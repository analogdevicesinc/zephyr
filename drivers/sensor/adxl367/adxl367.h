...
enum adxl367_instant_on_th_mode {
	ADXL367_INSTANT_ON_LOW_TH,
	ADXL367_INSTANT_ON_HIGH_TH
};

enum adxl367_wakeup_rate {
	ADXL367_WUR_52ms,
	ADXL367_WUR_104ms,
	ADXL367_WUR_208ms,
	ADXL367_WUR_512ms,
...
enum adxl367_filter_settle {
	ADXL367_FILTER_SETTLE_370,
	ADXL367_FILTER_SETTLE_16
};
...
struct adxl367_dev_config {
	...
	enum adxl367_range range;
	enum adxl367_act_proc_mode act_proc_mode;
	enum adxl367_wakeup_rate wur;
	enum adxl367_instant_on_th_mode	th_mode;
	enum adxl367_filter_settle filter_settle;
