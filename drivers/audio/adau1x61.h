...
#define ADAU1X61_MICBIAS_MBIEN     BIT(0)
#define ADAU17X1_MICBIAS_0_65_AVDD BIT(1)
...
#define ADAU1X61_DIFF_INPUT_VOL_EN   BIT(0)
#define ADAU1X61_DIFF_INPUT_VOL_MUTE BIT(1)
#define ADAU1X61_DIFF_INPUT_VOL_MASK 0xfc

#define ADAU1X61_PLAY_VOL_MASK    0xfc
#define ADAU1X61_PLAY_MUTE_MASK   BIT(1)
#define ADAU1X61_PLAY_LINE_HPMODE BIT(0)
...
#define ADAU1X61_PLAY_MIXER_LEFT0_MIXER_EN   BIT(0)
#define ADAU1X61_PLAY_MIXER_LEFT0_LEFT_MUTE  BIT(5)
#define ADAU1X61_PLAY_MIXER_LEFT0_RIGHT_MUTE BIT(6)

#define ADAU1X61_PLAY_MIXER_RIGHT0_MIXER_EN   BIT(0)
#define ADAU1X61_PLAY_MIXER_RIGHT0_LEFT_MUTE  BIT(5)
#define ADAU1X61_PLAY_MIXER_RIGHT0_RIGHT_MUTE BIT(6)

#define ADAU1X61_PLAY_LR_MIXER_LEFT_MIXER_EN  BIT(0)
#define ADAU1X61_PLAY_LR_MIXER_LEFT_MX5G3_0DB (0x1 << 1)
#define ADAU1X61_PLAY_LR_MIXER_LEFT_MX5G3_6DB (0x2 << 1)

#define ADAU1X61_PLAY_LR_MIXER_RIGHT_MIXER_EN  BIT(0)
#define ADAU1X61_PLAY_LR_MIXER_RIGHT_MX6G4_0DB (0x1 << 3)
#define ADAU1X61_PLAY_LR_MIXER_RIGHT_MX6G4_6DB (0x2 << 3)

#define ADAU1X61_PLAY_HP_LEFT_VOL_HPEN    BIT(0)
#define ADAU1X61_PLAY_HP_RIGHT_VOL_HPMODE BIT(0)

#define ADAU1X61_DAC_CONTROL0_DACEN_MASK      0x3
#define ADAU1X61_DAC_CONTROL0_DACEN_LEFT_DAC  BIT(0)
#define ADAU1X61_DAC_CONTROL0_DACEN_RIGHT_DAC BIT(1)

#define ADAU1X61_ADC_CONTROL_ADCEN_MASK      0x3
#define ADAU1X61_ADC_CONTROL_ADCEN_LEFT_ADC  BIT(0)
#define ADAU1X61_ADC_CONTROL_ADCEN_RIGHT_ADC BIT(1)

#define ADAU1X61_REC_MIXER_LEFT0_MIXER_EN  BIT(0)
#define ADAU1X61_REC_MIXER_RIGHT0_MIXER_EN BIT(0)
#define ADAU1X61_REC_MIXER_INPOS_GAIN(x)   ((0x7 & x) << 4)
#define ADAU1X61_REC_MIXER_INNEG_GAIN(x)   ((0x7 & x) << 1)

#define ADAU1X61_REC_MIXER_RDBOOST(x) ((0x3 & x) << 3)

#define ADAU1X61_REC_MIXER_AUX_GAIN(x) (0x7 & x)

#define ADAU1X61_PLAY_POWER_MGMT_PREN BIT(1)
#define ADAU1X61_PLAY_POWER_MGMT_PLEN BIT(0)
...
#define ADAU1761_SERIAL_INPUT_ROUTE_SI_TO_DAC  0x1
#define ADAU1761_SERIAL_OUTPUT_ROUTE_ADC_TO_SI 0x1

#define ADAU1761_CLK_ENABLE0_SPPD   BIT(0)
#define ADAU1761_CLK_ENABLE0_SINPD  BIT(1)
#define ADAU1761_CLK_ENABLE0_INTPD  BIT(2)
#define ADAU1761_CLK_ENABLE0_SOUTPD BIT(3)
#define ADAU1761_CLK_ENABLE0_DECPD  BIT(4)
#define ADAU1761_CLK_ENABLE0_ALCPD  BIT(5)
#define ADAU1761_CLK_ENABLE0_SLEWPD BIT(6)

#define ADAU1761_CLK_ENABLE1_CLK0 BIT(0)
#define ADAU1761_CLK_ENABLE1_CLK1 BIT(1)

/* Other macro definitions */
#define INPUT_GAIN_MUTE       0x0
#define INPUT_GAIN_MINUS_12DB 0x1
#define INPUT_GAIN_MINUS_9DB  0x2
#define INPUT_GAIN_MINUS_6DB  0x3
#define INPUT_GAIN_MINUS_3DB  0x4
#define INPUT_GAIN_0DB        0x5
#define INPUT_GAIN_3DB        0x6
#define INPUT_GAIN_6DB        0x7

#define INPUT_PGA_BOOST_MUTE 0x0
#define INPUT_PGA_BOOST_0DB  0x1
#define INPUT_PGA_BOOST_20DB 0x2

#define DIGITAL_VOLUME_MASK 0xff

#define DIGITAL_MIN_VOL (0)
#define DIGITAL_MAX_VOL (95 * 2)

#define LINE_MAX_VOL (6 * 2)
#define LINE_MIN_VOL (-57 * 2)

#define DIFF_IN_MAX_VOL (35 * 2)
#define DIFF_IN_MIN_VOL (-12 * 2)
